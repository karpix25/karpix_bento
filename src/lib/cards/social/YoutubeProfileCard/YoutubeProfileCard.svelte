...
>
	{#if profile}
		<div class="relative">
			...
			/>
			<div
				class="absolute -right-1 -bottom-1 flex h-6 w-6 items-center justify-center rounded-full bg-[#FF0000] text-white shadow-sm"
			>
		...
		<div class="flex flex-col items-center text-center">
			<h3 class="line-clamp-1 text-lg leading-tight font-bold">
				{profile.title}
			</h3>
			...
			<div
				class="mt-2 flex items-center gap-1.5 rounded-full bg-[#FF0000]/10 px-3 py-1 text-[#FF0000] dark:bg-[#FF0000]/20"
			>
	...
	{:else}
		<div class="flex flex-col items-center gap-3">
			<div
				class="bg-base-200 dark:bg-base-800 aspect-square size-20 animate-pulse rounded-full"
			></div>
			<div class="bg-base-200 dark:bg-base-800 h-4 w-24 animate-pulse rounded"></div>
			<div class="bg-base-200 dark:bg-base-800 h-6 w-32 animate-pulse rounded-full"></div>
		</div>
	{/if}
</a>
